...
exports.openBrowserForAuth = openBrowserForAuth;
 ...
 */
function openBrowserForAuth(url) {
 ...
 */
async function waitForOAuthCallback(expectedState, timeoutMs = DEFAULT_TIMEOUT_MS) {
    return new Promise((resolve, reject) => {
        ...
        timeoutHandle = setTimeout(() => {
            ...
            if (!settled) {
                settled = true;
                reject(new Error(`OAuth callback timed out after ${Math.round(timeoutMs / 1000)}s. No authorization code received.`));
            }
        }, timeoutMs);
